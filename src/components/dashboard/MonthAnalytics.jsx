...
const MonthAnalytics = () => {
  ...
  <div className="flex flex-wrap items-center justify-between mb-16 space-y-1">
    <h2 className="text-4xl font-bold text-gray-900">Analytics Overview</h2>
    <label>
  ...
  <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
    <div className="p-6 card shadow-lg rounded border">
      ...
      <p className="text-sm leading-none text-gray-600">Income</p>
    </div>
    <div className="p-6 card shadow-lg rounded border">
      <div className="flex items-start justify-between">
      ...
      <p className="text-sm leading-none text-gray-600">Expenses</p>
    </div>
    <div className="p-6 card shadow-lg rounded border">
      <div className="flex items-start justify-between">
      ...
      <p className="text-sm leading-none text-gray-600">Savings</p>
    </div>
    <div className="p-6 card shadow-lg rounded border">
      <div className="flex items-start justify-between">
