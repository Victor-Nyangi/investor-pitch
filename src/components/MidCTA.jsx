    ...
    <>
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Designed for any one</h2>
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400">Here at Team Z we focus on financial freedom, budgeting plans, investment calculations, savings and capital to help you unlock long-term value and drive economic growth.</p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Personal</h3>
                            <p className="text-gray-500 dark:text-gray-400">Stay in control of who you share your financial details with by creating your own account and getting your own custom dashboard.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">We handle the complex financial figures and provide in depth analysis of your financial activities, all packaged in a User friendly interface.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Automated</h3>
                            <p className="text-gray-500 dark:text-gray-400">Get reports, add expenses, income, integrate with your applications and follow your spending habits. See where the money goes.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Insightful</h3>
                            <p className="text-gray-500 dark:text-gray-400">Powerful and built for critical financial operations like month-end, close and quarterly budgeting. Life just gets easier and easier.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Multi-paradigm</h3>
                            <p className="text-gray-500 dark:text-gray-400">Our platform is available on Android, IOS and web. Making it easy for you to access your financial information  anywhere and anytime.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Scalable</h3>
                            <p className="text-gray-500 dark:text-gray-400">Feeling a bit left out. No worries, our enterprise package can be used by bigger enterprises, business, partners and SMEs. </p>
                        </div>
                    </div>
                </div>
            </section>
